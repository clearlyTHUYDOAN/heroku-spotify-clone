...
// Route songs={songs} passes the songs array to App.js
// Then the children of App.js gets passed certain data in the following line: 
// {React.cloneElement(this.props.children, {songs, selectSong})}
// Specifically, SongsList and SongDetails gets the songs array passed from index.js to App.js then App.js to its children.
// SongsList and SongDetails also get passed the selectSong method defined in App.js.
// Although SongDetails doesn't specifically use selectSong method.
